const stories = [
  ...
  },
  {
    ...
    //goals is to have printed madlib story printed in the console with words subsitutes in

    //output method resturns a template literal
    //template literal contains a 
    //need to conrsuct an object of keys (from words array) and values (whatever the user typed into the form) 
    //subsituting the value with whatever words paremter values 
    output: function (words) {
